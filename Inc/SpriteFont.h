...
namespace DirectX
{
    inline namespace DX12
    {
        ...
        public:
            ...
            DIRECTX_TOOLKIT_API SpriteFont(_In_ ID3D12Device* device,
            ...
            DIRECTX_TOOLKIT_API SpriteFont(_In_ ID3D12Device* device,
                ...
                D3D12_GPU_DESCRIPTOR_HANDLE                   gpuDescriptor,
                bool                                          forceSRGB = false);
            DIRECTX_TOOLKIT_API SpriteFont(D3D12_GPU_DESCRIPTOR_HANDLE texture,
                XMUINT2                                                textureSize,
            ...
            DIRECTX_TOOLKIT_API void XM_CALLCONV DrawString(_In_ SpriteBatch* spriteBatch,
            ...
            DIRECTX_TOOLKIT_API XMVECTOR XM_CALLCONV MeasureString(_In_z_ wchar_t const* text, bool ignoreWhitespace = true) const;

            DIRECTX_TOOLKIT_API
            RECT __cdecl MeasureDrawBounds(_In_z_ wchar_t const* text, XMFLOAT2 const& position, bool ignoreWhitespace = true) const;
            DIRECTX_TOOLKIT_API RECT XM_CALLCONV MeasureDrawBounds(_In_z_ wchar_t const* text,
                FXMVECTOR                                                                position,
            ...
            DIRECTX_TOOLKIT_API XMVECTOR XM_CALLCONV MeasureString(_In_z_ char const* text, bool ignoreWhitespace = true) const;

            DIRECTX_TOOLKIT_API
            RECT __cdecl MeasureDrawBounds(_In_z_ char const* text, XMFLOAT2 const& position, bool ignoreWhitespace = true) const;
            DIRECTX_TOOLKIT_API RECT XM_CALLCONV MeasureDrawBounds(_In_z_ char const* text,
                FXMVECTOR                                                             position,
                bool                                                                  ignoreWhitespace = true) const;
            ...
            DIRECTX_TOOLKIT_API SpriteFont(ID3D12Device* device,
                ResourceUploadBatch&                     upload,
            ...
            DIRECTX_TOOLKIT_API XMVECTOR XM_CALLCONV MeasureString(_In_z_ __wchar_t const* text, bool ignoreWhitespace = true) const;

            DIRECTX_TOOLKIT_API
            RECT __cdecl MeasureDrawBounds(_In_z_ __wchar_t const* text, XMFLOAT2 const& position, bool ignoreWhitespace = true) const;
            DIRECTX_TOOLKIT_API RECT XM_CALLCONV MeasureDrawBounds(_In_z_ __wchar_t const* text,
                FXMVECTOR                                                                  position,
                bool                                                                       ignoreWhitespace = true) const;
