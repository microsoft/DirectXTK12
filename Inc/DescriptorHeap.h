...
namespace DirectX
{
    ...
    {
    public:
        DIRECTX_TOOLKIT_API DescriptorHeap(_In_ ID3D12DescriptorHeap* pExistingHeap);
        DIRECTX_TOOLKIT_API DescriptorHeap(_In_ ID3D12Device* device, _In_ const D3D12_DESCRIPTOR_HEAP_DESC* pDesc);
        DIRECTX_TOOLKIT_API
        DescriptorHeap(_In_ ID3D12Device* device, D3D12_DESCRIPTOR_HEAP_TYPE type, D3D12_DESCRIPTOR_HEAP_FLAGS flags, size_t count);
        DIRECTX_TOOLKIT_API inline DescriptorHeap(_In_ ID3D12Device* device, size_t count)
            : DescriptorHeap(device, D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE, count)
        {}
        ...
        DIRECTX_TOOLKIT_API D3D12_GPU_DESCRIPTOR_HANDLE __cdecl WriteDescriptors(_In_ ID3D12Device* device,
        ...
        DIRECTX_TOOLKIT_API static void __cdecl DefaultDesc(_In_ D3D12_DESCRIPTOR_HEAP_TYPE type,
    ...
    public:
        ...
        DIRECTX_TOOLKIT_API inline DescriptorPile(_In_ ID3D12DescriptorHeap* pExistingHeap, size_t reserve = 0)
        ...
        DIRECTX_TOOLKIT_API inline DescriptorPile(_In_ ID3D12Device* device,
        ...
        DIRECTX_TOOLKIT_API inline DescriptorPile(_In_ ID3D12Device* device, size_t count, size_t reserve = 0)
            : DescriptorPile(device, D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE, count, reserve)
        {}
