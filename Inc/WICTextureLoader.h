...
namespace DirectX
{
    ...
    // Standard version
    DIRECTX_TOOLKIT_API
    HRESULT __cdecl LoadWICTextureFromMemory(_In_ ID3D12Device* device,
    ...
    DIRECTX_TOOLKIT_API
    HRESULT __cdecl CreateWICTextureFromMemory(_In_ ID3D12Device* device,
    ...
    // Extended version
    DIRECTX_TOOLKIT_API
    HRESULT __cdecl LoadWICTextureFromMemoryEx(_In_ ID3D12Device* device,
        _In_reads_bytes_(wicDataSize) const uint8_t*              wicData,
        size_t                                                    wicDataSize,
        size_t                                                    maxsize,
    ...
    DIRECTX_TOOLKIT_API
    HRESULT __cdecl CreateWICTextureFromMemoryEx(_In_ ID3D12Device* device,
        ResourceUploadBatch&                                        resourceUpload,
        _In_reads_bytes_(wicDataSize) const uint8_t*                wicData,
        size_t                                                      wicDataSize,
        size_t                                                      maxsize,
    ...
    DIRECTX_TOOLKIT_API
    inline HRESULT __cdecl LoadWICTextureFromMemory(_In_ ID3D12Device* device,
        ...
        size_t                                                         maxsize = 0) noexcept
    {
        return LoadWICTextureFromMemory(device,
    ...
    DIRECTX_TOOLKIT_API
    inline HRESULT __cdecl CreateWICTextureFromMemory(_In_ ID3D12Device* device,
        ResourceUploadBatch&                                             resourceUpload,
        _In_reads_bytes_(wicDataSize) const std::byte*                   wicData,
        size_t                                                           wicDataSize,
        _Outptr_ ID3D12Resource**                                        texture,
        ...
        size_t                                                           maxsize      = 0)
    {
        return CreateWICTextureFromMemory(device,
            resourceUpload,
            reinterpret_cast<const uint8_t*>(wicData),
            wicDataSize,
            texture,
    ...
    DIRECTX_TOOLKIT_API
    inline HRESULT __cdecl LoadWICTextureFromMemoryEx(_In_ ID3D12Device* device,
        _In_reads_bytes_(wicDataSize) const std::byte*                   wicData,
        size_t                                                           wicDataSize,
        size_t                                                           maxsize,
        D3D12_RESOURCE_FLAGS                                             resFlags,
    ...
    DIRECTX_TOOLKIT_API
    inline HRESULT __cdecl CreateWICTextureFromMemoryEx(_In_ ID3D12Device* device,
        ResourceUploadBatch&                                               resourceUpload,
        _In_reads_bytes_(wicDataSize) const std::byte*                     wicData,
        size_t                                                             wicDataSize,
        size_t                                                             maxsize,
