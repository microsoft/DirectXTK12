...
To explore more about DirectX 12 Graphics functionality, continue with the tutorials at [Getting Started](https://github.com/microsoft/DirectXTK12/wiki/Getting-Started) starting at [Rendering a model](https://github.com/microsoft/DirectXTK12/wiki/Rendering-a-model).
