...
const D3D12_BLEND_DESC CommonStates::Opaque = { FALSE, // AlphaToCoverageEnable
...
const D3D12_BLEND_DESC CommonStates::AlphaBlend = { FALSE, // AlphaToCoverageEnable
    FALSE,                                                 // IndependentBlendEnable
    { { TRUE,                                              // BlendEnable
        FALSE,                                             // LogicOpEnable
        D3D12_BLEND_ONE,                                   // SrcBlend
...
const D3D12_BLEND_DESC CommonStates::Additive = { FALSE, // AlphaToCoverageEnable
    FALSE,                                               // IndependentBlendEnable
    { { TRUE,                                            // BlendEnable
        FALSE,                                           // LogicOpEnable
...
const D3D12_BLEND_DESC CommonStates::NonPremultiplied = { FALSE, // AlphaToCoverageEnable
    FALSE,                                                       // IndependentBlendEnable
    { { TRUE,                                                    // BlendEnable
        FALSE,                                                   // LogicOpEnable
        D3D12_BLEND_SRC_ALPHA,                                   // SrcBlend
...
const D3D12_RASTERIZER_DESC CommonStates::CullNone = { D3D12_FILL_MODE_SOLID,
...
const D3D12_RASTERIZER_DESC CommonStates::CullClockwise = { D3D12_FILL_MODE_SOLID,
...
const D3D12_RASTERIZER_DESC CommonStates::CullCounterClockwise = { D3D12_FILL_MODE_SOLID,
...
const D3D12_RASTERIZER_DESC CommonStates::Wireframe = { D3D12_FILL_MODE_WIREFRAME,
    D3D12_CULL_MODE_NONE,
    FALSE, // FrontCounterClockwise
    D3D12_DEFAULT_DEPTH_BIAS,
    D3D12_DEFAULT_DEPTH_BIAS_CLAMP,
...
CommonStates::StaticPointWrap(unsigned int shaderRegister, D3D12_SHADER_VISIBILITY shaderVisibility, unsigned int registerSpace) noexcept
{
...
const D3D12_STATIC_SAMPLER_DESC
CommonStates::StaticPointClamp(unsigned int shaderRegister, D3D12_SHADER_VISIBILITY shaderVisibility, unsigned int registerSpace) noexcept
{
    static const D3D12_STATIC_SAMPLER_DESC s_desc = {
        D3D12_FILTER_MIN_MAG_MIP_POINT,
...
const D3D12_STATIC_SAMPLER_DESC
CommonStates::StaticLinearWrap(unsigned int shaderRegister, D3D12_SHADER_VISIBILITY shaderVisibility, unsigned int registerSpace) noexcept
{
    static const D3D12_STATIC_SAMPLER_DESC s_desc = {
...
const D3D12_STATIC_SAMPLER_DESC
CommonStates::StaticLinearClamp(unsigned int shaderRegister, D3D12_SHADER_VISIBILITY shaderVisibility, unsigned int registerSpace) noexcept
{
    static const D3D12_STATIC_SAMPLER_DESC s_desc = {
        D3D12_FILTER_MIN_MAG_MIP_LINEAR,
        D3D12_TEXTURE_ADDRESS_MODE_CLAMP, // AddressU
...
const D3D12_STATIC_SAMPLER_DESC CommonStates::StaticAnisotropicWrap(unsigned int shaderRegister,
...
const D3D12_STATIC_SAMPLER_DESC CommonStates::StaticAnisotropicClamp(unsigned int shaderRegister,
    D3D12_SHADER_VISIBILITY                                                       shaderVisibility,
    unsigned int                                                                  registerSpace) noexcept
{
    static const D3D12_STATIC_SAMPLER_DESC s_desc = {
...
public:
    ...
    explicit Impl(_In_ ID3D12Device* device)
        : mDescriptors(device,
              ...
              static_cast<size_t>(SamplerIndex::Count))
    {
        if (!device)
    ...
    D3D12_GPU_DESCRIPTOR_HANDLE Get(SamplerIndex i) const { return mDescriptors.GetGpuHandle(static_cast<size_t>(i)); }

    ID3D12DescriptorHeap* Heap() const noexcept { return mDescriptors.Heap(); }
...
_Use_decl_annotations_ CommonStates::CommonStates(ID3D12Device* device)
