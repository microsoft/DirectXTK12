...
_Use_decl_annotations_ DescriptorHeap::DescriptorHeap(ID3D12DescriptorHeap* pExistingHeap)
...
_Use_decl_annotations_ DescriptorHeap::DescriptorHeap(ID3D12Device* device, const D3D12_DESCRIPTOR_HEAP_DESC* pDesc)
    : m_desc{},
      m_hCPU{},
      m_hGPU{},
      m_increment(0)
...
DescriptorHeap::DescriptorHeap(ID3D12Device* device, D3D12_DESCRIPTOR_HEAP_TYPE type, D3D12_DESCRIPTOR_HEAP_FLAGS flags, size_t count)
    : m_desc{},
      m_hCPU{},
      m_hGPU{},
      m_increment(0)
...
_Use_decl_annotations_ D3D12_GPU_DESCRIPTOR_HANDLE DescriptorHeap::WriteDescriptors(ID3D12Device* device,
...
_Use_decl_annotations_ void DescriptorHeap::Create(ID3D12Device* pDevice, const D3D12_DESCRIPTOR_HEAP_DESC* pDesc)
{
    if (!pDevice)
    ...
    {
        ThrowIfFailed(pDevice->CreateDescriptorHeap(pDesc, IID_GRAPHICS_PPV_ARGS(m_pHeap.ReleaseAndGetAddressOf())));
...
_Use_decl_annotations_ void DescriptorHeap::DefaultDesc(D3D12_DESCRIPTOR_HEAP_TYPE type, D3D12_DESCRIPTOR_HEAP_DESC* pDesc) noexcept
{
