...
.SYNOPSIS
Updates the vcpkg port for DirectXTK12 to match a GitHub release.

.DESCRIPTION
This script updates the vcpkg port at D:\vcpkg\ports\directxtk12 to match a specific
...
$portDir = "D:\vcpkg\ports\directxtk12"
...
$sourceUrl = "https://github.com/Microsoft/DirectXTK12/archive/refs/tags/$Tag.tar.gz"
...
$makespriteFontUrl = "https://github.com/Microsoft/DirectXTK12/releases/download/$Tag/MakeSpriteFont.exe"
...
$xwbtoolUrl = "https://github.com/Microsoft/DirectXTK12/releases/download/$Tag/XWBTool.exe"
...
$xwbtoolArm64Url = "https://github.com/Microsoft/DirectXTK12/releases/download/$Tag/XWBTool_arm64.exe"
