...
.DESCRIPTION
Creates GPG-signed annotated tags on both the DirectXTK12 repository and the
DirectXTK12 test suite repository (Tests/), then publishes a GitHub release on
the DirectXTK12 repository using the signed tag.
...
release on microsoft/DirectXTK12. Can also be provided via the GITHUB_TOKEN
...
#--- Create verified tag and release on microsoft/DirectXTK12 ---
...
#--- Create verified tag on walbourn/directxtk12test ---
